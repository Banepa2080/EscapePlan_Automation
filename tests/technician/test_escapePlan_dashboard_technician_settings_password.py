...
from pages.technician.escapePlan_dashboard_technician_settings_password_page import TechnicianPasswordChangePage
...
def test_client_can_update_profile(page: Page) -> None:
    ...
    password_page = TechnicianPasswordChangePage(page)
