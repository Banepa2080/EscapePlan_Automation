...
from pages.admin.escapePlan_dashboard_admin_printer_jobs_page import (
    AdminPrinterJobsPage,
)
...
def test_admin_can_open_printer_job(page: Page) -> None:
    login_page = LoginPage(page)
    printer_jobs_page = AdminPrinterJobsPage(page)
   ...
   #Step 2: Verify dashboard
    ...
    #Step 3:
    # Open Printer Jobs
    printer_jobs_page.click_printer_jobs()

    # Verify Job Title is visible
    expect(
        printer_jobs_page.job_title_text
    ).to_be_visible()

    # Click the 3rd "printer job" cell
    printer_jobs_page.click_printer_job(2)
