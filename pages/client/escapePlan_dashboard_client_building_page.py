...
class ClientBuildingPage:
    ...
    def __init__(self, page:Page):
        ...
        self.building_address_input = page.get_by_role("textbox", name="e.g. 123 Main St, Kathmandu")
        self.building_details_input = page.get_by_role("textbox", name="Add any additional information about this building...")
